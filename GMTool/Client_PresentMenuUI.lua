...
function SubmitClicked()
	...
	if (TargetPlayerID ~= WL.PlayerID.Neutral) then
		msg = 'Transferring ' .. SelectedTerritory.Name .. '" from ' .. game.Game.Players[game.ServerGame.LatestTurnStanding.Territories[SelectedTerritory.ID].OwnerPlayerID].DisplayName(nil, false) .. ' to ' .. game.Game.Players[TargetPlayerID].DisplayName(nil, false);
	else
