...
if SU ~= nil and #SU > 0  and targetPlayerID ~= WL.PlayerID.Neutral then
    	...
    	for _, v in pairs(SU) do
			...
			message = 'Transferring SU('  .. builder.name .. ') from ' .. game.Game.Players[v.OwnerID].DisplayName(nil, false) .. ' to ' .. game.Game.Players[builder.OwnerID].DisplayName(nil, false);
